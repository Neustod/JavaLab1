...
public class MyWin extends JFrame implements ActionListener 
{
    ...
    public MyWin() 
    {
        ...
        // Buttons's resize.
        jbtnAdd.setBounds(10, 310, 180, 50);
        jbtnClear.setBounds(10, 370, 180, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        {   
            ...
            dtResultsModel.addRow(new String[]{String.valueOf(ic.A()), String.valueOf(ic.B()), String.valueOf(ic.E()), String.valueOf(ic.F())});
        }
